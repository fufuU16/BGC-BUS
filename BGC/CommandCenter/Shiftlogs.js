...
function fetchLogs() {
    // This function should fetch logs from the server
    // For demonstration, we'll use a static array
    const logs = [
        { driver: 'Juan Dela Cruz', bus: '01', time: '15:00',date:'2024-10-11', status: 'Time In', moreInfo: 'Central Route' },
        { driver: 'Maria Clara', bus: '02',  time: '12:00',date:'2024-15-11', status: 'Time Out', moreInfo: 'North Route' },
